...
class Node3d {
   public:
    ...
    Node3d(const double x, const double y, const double phi, const std::vector<double> &XYbounds,
    ...
    static math::Box2d GetBoundingBox(const common::VehicleParam &vehicle_param_, const double x,
